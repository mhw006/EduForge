...
// ─── Tab IDs ─────────────────────────────────────────────────────────────────
const TABS = [
  { id: 'curriculum', label: 'Units & Curriculum' },
  { id: 'assignments', label: 'Assignments' },
  { id: 'interactive', label: 'Interactive Center' },
  { id: 'planner', label: 'Study Planner' },
  { id: 'bonfire', label: 'My Bonfire' },
]
      ...
      <div className="sv-lesson-detail">
        {active ? (
          <>
            ...
            <p style={{ marginTop: '1rem' }}>Select this lesson from your teacher's queue. Use the <strong>Interactive Center</strong> tab to read it with TTS, language support, and highlighted key terms.</p>
          </>
        ) : (
...
const PLAN_ITEMS = [
  ...
  { day: 5, task: 'Interactive Center — listen to adapted lesson', type: 'fun' },
...
export default function StudentView() {
  ...
  function renderTab() {
    switch (activeTab) {
      ...
      case 'interactive':  return <InteractiveCenterTab />
